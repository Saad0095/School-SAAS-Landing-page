...
import logo from "../assets/SchoolSync-logo.png";
import image1 from "../assets/media/Super Admin (1).jpeg";
import image2 from "../assets/media/Teacher (1).jpeg";
import image3 from "../assets/media/Teacher (4).jpeg";
import image4 from "../assets/media/Teacher (3).jpeg";
import image5 from "../assets/media/Student (1).jpg";
      ...
      <section className="pt-32 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-[800px] mx-auto text-center relative">
          ...
          <div className="mt-16 relative">
            ...
            <img
              src={image1}
              alt="SchoolSync Dashboard"
              className="relative mx-auto rounded-2xl shadow-2xl border border-gray-200 max-w-full"
            />
          </div>
        </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Mark attendance instantly and generate reports without
                paperwork.
              </p>
            </div>
            <img
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Generate academic and administrative reports in seconds.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mt-16">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Teachers can create exams, enter and update scores, and track
                student performance in one place. Generate reports automatically
                for each class or student.
              </p>
            </div>
            <img
              src={image4}
      ...
      >
        ...
        >
          ...
          <div className="mt-16">
            <img
              src={image5}
              alt="AI Student Insights"
              className="mx-auto rounded-2xl shadow-xl border border-gray-200"
            />
          </div>
        </div>
      </section>
